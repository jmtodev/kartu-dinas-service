...
class Http:
    ...
    def http_patch(url: str, payload: dict = None, timeout: int = 10, headers: dict = None):
        try:
            default_headers = {
                "Content-Type": "application/json",
                "User-Agent": "Mozilla/5.0",
            ...
            response = requests.patch(
                url,
                json=payload,   # 👈 kirim sebagai body JSON
            ...
            logger.error(f"PATCH {url} | Request timed out")
            return None
